...
jsonSource_Parcelas_4.addFeatures(features_Parcelas_4);var lyr_Parcelas_4 = new ol.layer.Vector({
                declutter: true,
...
jsonSource_Calles_5.addFeatures(features_Calles_5);var lyr_Calles_5 = new ol.layer.Vector({
                declutter: true,
...
lyr_Red_Cloaca_0.setVisible(true);lyr_Red_Agua_1.setVisible(true);lyr_Barrios_2.setVisible(true);lyr_Clientes_3.setVisible(true);lyr_Parcelas_4.setVisible(true);lyr_Calles_5.setVisible(true);
var layersList = [baseLayer,lyr_Red_Cloaca_0,lyr_Red_Agua_1,lyr_Barrios_2,lyr_Clientes_3,lyr_Parcelas_4,lyr_Calles_5];
...
lyr_Parcelas_4.set('fieldAliases', {'gid': 'gid', 'objectid_1': 'objectid_1', 'objectid': 'objectid', 'tipo': 'tipo', 'shape_area': 'shape_area', 'shape_len': 'shape_len', });
lyr_Calles_5.set('fieldAliases', {'gid': 'gid', 'objectid_1': 'objectid_1', 'objectid': 'objectid', 'handle': 'handle', 'text': 'text', 'shape_len': 'shape_len', });
...
lyr_Parcelas_4.set('fieldImages', {'gid': 'TextEdit', 'objectid_1': 'TextEdit', 'objectid': 'TextEdit', 'tipo': 'TextEdit', 'shape_area': 'TextEdit', 'shape_len': 'TextEdit', });
lyr_Calles_5.set('fieldImages', {'gid': 'TextEdit', 'objectid_1': 'TextEdit', 'objectid': 'TextEdit', 'handle': 'TextEdit', 'text': 'TextEdit', 'shape_len': 'TextEdit', });
...
lyr_Parcelas_4.set('fieldLabels', {'gid': 'no label', 'objectid_1': 'no label', 'objectid': 'no label', 'tipo': 'no label', 'shape_area': 'no label', 'shape_len': 'no label', });
lyr_Calles_5.set('fieldLabels', {'gid': 'no label', 'objectid_1': 'no label', 'objectid': 'no label', 'handle': 'no label', 'text': 'no label', 'shape_len': 'no label', });
lyr_Calles_5.on('precompose', function(evt) {
